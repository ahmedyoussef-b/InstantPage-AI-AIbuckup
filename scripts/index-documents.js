...
const documents = [
  ...
  },
  {
    ...
    metadata: { type: "procedure", category: "demarrage", source: "manuel_exploitation" }
  },
  {
    ...
    metadata: { type: "alarme", category: "securite", source: "procedures_urgences" }
  },
  {
    ...
    metadata: { type: "maintenance", category: "preventive", source: "plan_maintenance" }
  }
];
...
async function indexDocuments() {
  ...
  try {
    ...
    for (const doc of documents) {
      ...
      console.log(`  OK ${doc.id}: ${doc.content.substring(0, 60)}...`);
    }
