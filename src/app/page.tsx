...
import { Bot, LayoutDashboard, Settings, MessageSquare, ShieldCheck, HelpCircle, HardDrive, Menu } from 'lucide-react';
...
export default function HomePage() {
  const SidebarContent = () => (
    <div className="p-6 flex flex-col h-full bg-[#171717]">
  ...
  return (
    <main className="h-screen flex bg-[#171717] overflow-hidden selection:bg-blue-500/30">
      ...
      <aside className="w-72 flex-col hidden lg:flex border-r border-white/5 bg-[#171717] transition-all">
        <SidebarContent />
      </aside>
