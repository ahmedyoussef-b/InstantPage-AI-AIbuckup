// src/components/upload/DocumentManager.tsx
'use client';
...
export default function DocumentManager() {
  ...
  const getEquipmentColor = (equipment: string) => {
    const colors: Record<string, string> = {
      'TG1': 'bg-blue-100 text-blue-800',
      'TG2': 'bg-blue-100 text-blue-800',
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Recherche */}
      <div className="bg-[#171717] rounded-lg border border-white/5 p-6">
                    ...
                    {doc.metadata && (
                      <div className="flex flex-wrap gap-2">
                        ...
                        {doc.metadata.equipment && doc.metadata.equipment !== 'general' && (
                          <Badge className={cn("text-xs", getEquipmentColor(doc.metadata.equipment))}>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent className="bg-[#171717] border-white/10">
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="bg-transparent text-gray-400 hover:bg-white/10">
              Annuler
            </AlertDialogCancel>
